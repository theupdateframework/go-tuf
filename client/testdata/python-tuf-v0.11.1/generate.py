...
parent_dir = 'repository/targets/'
target1_filepath = parent_dir + 'file1.txt'
securesystemslib.util.ensure_parent_dir(target1_filepath)
target2_filepath = parent_dir + 'dir/file2.txt'
...
repository.targets.add_target(target1_filepath[len(parent_dir):], file_permissions)
repository.targets.add_target(target2_filepath[len(parent_dir):])
